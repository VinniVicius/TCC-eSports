...
<section class="container-fluid bg-eyestrain">
    <div class="row justify-content-center align-items-center" style="min-height: 35vh;">
      <button type="button" class="btn btn-dark btn-lg rounded-0 btn-full-negro bg-diamond">Tenossinovite Estenosante</button>
     </div>
</section>

<section class="container-fluid bg-tenosynovitis" id="Content1"></section>
...
<section class="container-fluid bg-eyestrain2-content">
    <article class="container" style="padding-bottom: 20px; padding-top: 20px;">
        <p class="text-center">
            ...
            <br>
            <br>
            <li style="color: #0eb7b7;">Posição ruim da mão</li>
            ...
            <span style="color: #0eb7b7;">Desvio radial:</span> é o termo para dobrar seu pulso em direção ao lado do polegar.<br>
            <span style="color: #0eb7b7;">Desvio ulnar:</span> é o termo para dobrar seu pulso em direção ao lado mindinho.
            <br>
            <br>
            <li style="color: #0eb7b7;">Pulando seu aquecimento</li>
            ...
            <br>
            <br>
            <li style="color: #0eb7b7;">Pulando seu tempo de Descanso</li>
