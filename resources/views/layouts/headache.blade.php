...
<section class="container-fluid bg-eyestrain">
    <div class="row justify-content-center align-items-center" style="min-height: 35vh;">
      <button type="button" class="btn btn-dark btn-lg rounded-0 btn-full-negro bg-diamond">Dor de Cabeça (Tensão)</button>
     </div>
</section>

<section class="container-fluid bg-headache" id="Content1"></section>
