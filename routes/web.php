...
Route::get('/conteudo/tendinite-bicipital', 'MouseShoulderController@index')->name('mouseshoulder');
Route::get('/conteudo/epicondilose-lateral','MouseElbowController@index')->name('mouseelbow');
